\begin{tikzpicture}[scale=0.8, every node/.style={font=\small}]
    ...
    \begin{scope}[local bounding box=horizontal, shift={(0.3cm,0cm)}]
        ...
        \draw[->,thick] ([xshift=0.3cm]sumblock2.east) -- ++(0.9,0) node[midway, above] {\footnotesize $\cdots$};

        % Second sum block positioned horizontally next to the first
        \begin{scope}[local bounding box=returnct, shift={([xshift=1.5cm]sumblock2.south east)}]
    ...
    % Final result matrix
    \begin{scope}[local bounding box=return_matrix, shift={(10.5cm,5.5cm)}]
        \draw[fill=blue!20, draw=blue] (0,0) rectangle (1,4);
        \draw[blue] (0,0.8) -- (1,0.8);
        \draw[blue] (0,2.4) -- (1,2.4);
        \draw[blue] (0,3.2) -- (1,3.2);
    ...
    \draw[->,thick, dashed] ([xshift=0.3cm]horizontal.east) -| ([yshift=-0.3cm]return_matrix.south) node[midway, right, yshift=1cm, align=left] {\footnotesize create $\frac{\ell}{slots}$ \\ ciphertexts };
