...
Subsequently, an instance of GBFV is created. When creating this instance, one has to set $m$ the cyclotomic order, $p_mod$ the integer modulus and $t$ the plaintext modulus. EasyGBFV has some GBFV parameters already set, to create GBFV instances of 16/32/64 bits of plaintext modulus. 
